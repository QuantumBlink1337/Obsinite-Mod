...
public class PowergenContainer extends AbstractContainerMenu {
    ...
    public boolean stillValid(@NotNull Player playerIn) {
        return stillValid(ContainerLevelAccess.create(Objects.requireNonNull(blockEntity.getLevel()), blockEntity.getBlockPos()), playerEntity, BlockEntityMod.POWERGEN.get());
    }
